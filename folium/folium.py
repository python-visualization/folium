...
""")  # noqa
    ...
    def add_vector_grid_choropleth(self, tiles, data, field, name=None, options=None):
        """
        ...
        Usage
        -----
        See examples/VectorGrid.ipynb (may need ipythonwidgets installed)
        """
        _default_js.append(
            ('vectorGrid', 'https://unpkg.com/leaflet.vectorgrid@1.3.0/dist/Leaflet.VectorGrid.bundled.js'))
        vectorGridChoropleth = VectorGridChoropleth(tiles=tiles, name=name, data=data, field=field, options=options)
        self.add_child(vectorGridChoropleth, name=name)
